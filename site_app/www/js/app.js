...
angular.module('ApplicationTest', [
  'ionic',
  'ApplicationTest.common.directives',
  'ApplicationTest.app.services',
  'ApplicationTest.app.filters',
  'ApplicationTest.app.controllers',
  'ApplicationTest.auth.controllers',
  // 'ApplicationTest.views',
  'underscore',
  'angularMoment',
  'ngCordova',
  'monospaced.elastic'
